...
export default function BudgetPage() {
  ...
  useEffect(() => {
    fetchOrdersAndBudgets()
  }, [selectedPeriod])

  async function fetchOrdersAndBudgets() {
    try {
      setLoading(true)
      
      // TODO: Implementera Supabase-anrop för orders och budgets
    ...
    const mockBudgetData: BudgetData[] = [
      { month: 'Jan', budgeted: 100000, actual: 125000, orders: 3 },
      { month: 'Feb', budgeted: 120000, actual: 95000, orders: 2 },
      { month: 'Mar', budgeted: 150000, actual: 180000, orders: 4 },
      { month: 'Apr', budgeted: 130000, actual: 145000, orders: 3 },
      { month: 'Maj', budgeted: 140000, actual: 125000, orders: 2 },
      { month: 'Jun', budgeted: 160000, actual: 175000, orders: 4 },
      { month: 'Jul', budgeted: 120000, actual: 110000, orders: 2 },
      { month: 'Aug', budgeted: 180000, actual: 200000, orders: 5 },
    ]

    const mockCategories: BudgetCategory[] = [
      { id: '1', name: 'CRM Licenser', budgeted: 500000, color: 'blue', orderKeywords: ['license', 'licens', 'crm'] },
      { id: '2', name: 'Implementationer', budgeted: 800000, color: 'emerald', orderKeywords: ['implementation', 'implementering', 'consulting'] },
      { id: '3', name: 'Support & Underhåll', budgeted: 300000, color: 'purple', orderKeywords: ['support', 'maintenance', 'underhåll'] },
      { id: '4', name: 'Anpassningar', budgeted: 400000, color: 'amber', orderKeywords: ['custom', 'anpassning', 'integration'] }
    ]
