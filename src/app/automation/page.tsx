      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-100">Automatisering</h1>
              <p className="text-slate-400">Hantera automatiska processer och arbetsflöden</p>
            </div>
          </div>
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6">
              ...
              <div className="space-y-4">
                {automations.map((automation) => (
                  <div key={automation.id} className="flex items-center justify-between p-4 bg-slate-700/30 rounded-lg">
                    <span className="text-slate-200">{automation.name}</span>
                    <button
